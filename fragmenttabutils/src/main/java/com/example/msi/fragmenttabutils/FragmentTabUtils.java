package com.example.msi.fragmenttabutils;

/**
 * Created by john on 2015-08-02.
 */
...
public class FragmentTabUtils implements RadioGroup.OnCheckedChangeListener {
    ...
    public FragmentTabUtils(final FragmentManager fragmentManager, final List<Fragment> fragments, final int fragmentContentId, RadioGroup rgs) {
    ...
    public void  init(int fragmentContentId,int currentTab){
